...
plot(variograma, ylab = "Semivariância", xlab = "Distância (m)") +
  latticeExtra::layer(lattice::panel.abline(h = var(pontos400in$residuo), col = 'red', lty = 'dashed')) +
  latticeExtra::layer(lattice::panel.text(y = var(pontos400in$residuo), x = 1500, label = "Variância amostral", pos = 3))
```
...
plot(variograma, ylab = "Semivariância", xlab = "Distância (m)") +
  layer(panel.abline(
    h = c(var(pontos400in$residuo), min(variograma$gamma)), v = 1500, col = 'red', lty = 'dashed')) +
  layer(panel.text(
    x = c(600, 600, 1500), 
    y = c(var(pontos400in$residuo), min(variograma$gamma), max(variograma$gamma) / 2), 
  ...
  layer(panel.arrows(
    ...
    y1 = c(var(pontos400in$residuo), min(variograma$gamma), 18000), length = 0.1, ends = 'both')) +
