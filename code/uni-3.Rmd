...
```{r}
fit_reml <- georob::georob(
  areia_ ~ um, pontos400in, locations = ~ coord_x + coord_y, variogram.model = 'RMexp', 
  param = c(variance = vario_fit$variogram.object[[1]]$param[[1]], 
            nugget = vario_fit$variogram.object[[1]]$param[[3]], 
            scale = vario_fit$variogram.object[[1]]$param[[4]]),
