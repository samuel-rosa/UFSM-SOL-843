...
plot(variograma, ylab = "Semivariância", xlab = "Distância (m)") +
  latticeExtra::layer(lattice::panel.abline(h = var(pontos400in$residuo), col = 'red', lty = 'dashed')) +
  latticeExtra::layer(lattice::panel.text(variograma$dist, variograma$gamma, variograma$np, pos = 1)) +
  latticeExtra::layer(lattice::panel.text(y = var(pontos400in$residuo), x = 500, label = "Variância amostral", pos = 3))
```
